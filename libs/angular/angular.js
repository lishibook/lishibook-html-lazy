 ...
 * each of the subsequent js.   This prevents strange results in applications, where otherwise
 ...
 * for a manual update. The example is shown in two different declaration css you may use
 ...
 * specificity (when !important isn't used with any conflicting css). If a developer chooses to override the
 * styling to change how to hide an element then it is just a matter of using !important in their own CSS code.
 *
 * ### Overriding .ng-hide
 *
 * If you wish to change the hide behavior with ngShow/ngHide then this can be achieved by
 * restating the css for the .ng-hide class in CSS:
 * ```css
 * .ng-hide {
    ...
    compile: function(element, attr) {
      if (attr.type == 'text/ng-template') {
        var templateUrl = attr.id,
            // IE is not consistent, in js we have to read .text but in other nodes we have to read .textContent
            text = element[0].text;
